<?php
    ...
    $queryProduk = "SELECT id_barang, nama_barang, kategori, foto, harga, detail FROM produk where kategori = 'Secondhand' and not status_barang = 'Sold Out' ";
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light main-color">
              ...
              <section id="products" class="mt-5">
                <div class="prod">
                <h2 style="margin:0px 350px 40px 350px; padding: 20px 0px 20px 0px; font-weight: bold; background-color: #F6F1E9; border-radius: 35px; text-align: center;">Secondhand</h2>
                <div class="row row-cols-1 row-cols-md-3 g-4">

                <?php
                        if (isset($_GET['cari'])){
                            $cari = $_GET['cari'];
                            $querySearch = "SELECT id_barang, nama_barang, kategori, foto, harga, detail FROM produk WHERE kategori = 'Secondhand' AND NOT status_barang = 'Sold Out' AND (nama_barang LIKE '%$cari%' OR detail LIKE '%$cari%')";
