    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light main-color">
      ...
      <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #f2f2f2;" class="mt-3">
            <ol class="breadcrumb p-3">
              ...
              <li class="breadcrumb-item"><a href="RPL_LisItem.php" class="text-decoration-none">Upload</a></li>
            </ol>
          </nav>
      </div>
      ...
      <div class="container mt-5">
        <!-- <div class="my-5 col-12 col-md-6"> -->
          ...
          <form action="Simpan_upload.php" method="post" enctype="multipart/form-data" class="form-upload">
              <div class="label">
                  <label for="nama">Nama Barang</label>
                  <input type="text" id="nama" name="nama" class="form-control input-label">
              </div>
              <div class="label">
              ...
              <div class="label">
                  ...
                  <input type="number" name="harga" id="harga" class="form-control input-label">
              </div>
              <div class="label">
              ...
              <div class="label">
                <img id="img" src="../assets/catSH/addPic.jpg" height="200">
              </div>
              <div class="label">
                  <label for="detail">Deskripsi Barang</label>
                  <textarea name="detail" id="detail" id="" cols="30" rows="50" class="form-control input-label"></textarea>
              </div>
              <div class="button">
